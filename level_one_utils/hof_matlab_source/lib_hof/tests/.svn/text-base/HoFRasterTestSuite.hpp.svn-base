#ifndef TESTTESTSUITE_H_
#define TESTTESTSUITE_H_

#include <cxxtest/TestSuite.h>

#include "../src/raster/raster.hpp"
...
class HoFRasterTestSuite : public CxxTest::TestSuite
{
	public:
		...
		void init_data()
		{
			...
			_obj_A_small_top_left = copy_object(_black_canvas, 20, 20, _square, 1, 1, 0, 0);
			_obj_B_small_top_left = copy_object(_black_canvas, 20, 20, _square, 1, 1, 2, 0);

			_obj_A_small_middle = copy_object(_black_canvas, 20, 20, _square, 1, 1, 9, 10);
			_obj_B_small_middle = copy_object(_black_canvas, 20, 20, _square, 1, 1, 11, 10);

			_numberDirections = 180;
		...
		void test_Raster_Disjoint_F0()
		{
			...
			std::cout << "F0 Right-Below: " << printHistogram(_histogram) << std::endl;
			...
			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.FRHistogram_CrispRaster (&_histogram[0], _numberDirections, 0, &_obj_A_small_top_left[0], &_obj_B_small_top_left[0], 20, 20);
			std::cout << "F0 Small Top-Left: " << printHistogram(_histogram) << std::endl;

			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.FRHistogram_CrispRaster (&_histogram[0], _numberDirections, 0, &_obj_A_small_middle[0], &_obj_B_small_middle[0], 20, 20);
			std::cout << "F0 Small Middle: " << printHistogram(_histogram) << std::endl;
		}
		...
		void test_Raster_Disjoint_F2()
		{
			...
			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.FRHistogram_CrispRaster (&_histogram[0], _numberDirections, 2.0, &_obj_A_small_top_left[0], &_obj_B_small_top_left[0], 20, 20);
			std::cout << "F2 Small Top-Left: " << printHistogram(_histogram) << std::endl;

			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.FRHistogram_CrispRaster (&_histogram[0], _numberDirections, 2.0, &_obj_A_small_middle[0], &_obj_B_small_middle[0], 20, 20);
			std::cout << "F2 Small Middle: " << printHistogram(_histogram) << std::endl;
		}
		...
		void test_Raster_Overlap_FH()
		{
			...
			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.F02Histogram_CrispRaster (&_histogram[0], _numberDirections, &_obj_A_small_top_left[0], &_obj_B_small_top_left[0], 20, 20, _p0, _p1);
			std::cout << "F02 Small Top-Left: " << printHistogram(_histogram) << std::endl;

			_histogram.resize( static_cast<unsigned int>(_numberDirections+1), 0 );
			H.F02Histogram_CrispRaster (&_histogram[0], _numberDirections, &_obj_A_small_middle[0], &_obj_B_small_middle[0], 20, 20, _p0, _p1);
			std::cout << "F02 Small Middle: " << printHistogram(_histogram) << std::endl;
		}
		...
		void test_write_image()
		{
			...
			writeImage( _obj_A_small_top_left, _obj_B_small_top_left, 20, 20, "small_top_left.tif" );
			writeImage( _obj_A_small_middle, _obj_B_small_middle, 20, 20, "small_middle.tif" );
		}
	...
	private:
		...
		std::vector<unsigned char> _obj_A_small_top_left;
		std::vector<unsigned char> _obj_A_small_middle;
		std::vector<unsigned char> _obj_B_small_top_left;
		std::vector<unsigned char> _obj_B_small_middle;
};
