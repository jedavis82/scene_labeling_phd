...
The first version of this program has been written by Laurent Wendling in 1996/1997.
This program implements the notion of F-histograms, which has been presented in detail
in the dissertation of Pascal Matsakis (IRIT, 1998). This program has been updated later
around February/March 2001.

1/ Many of the tests have been conducted. They have helped to highlight some bugs which
   have been corrected. The tests are supported on the following facts :

   - The values of F0 in the horizontal and vertical directions can easily be calculated by hand.
   - The rotation of objects corresponds to a translation of the histogram.
   - The dilation of objects corresponds to a dilation of the histogram.
   - The histogram can be calculated for a pair of fuzzy objects.
     des histogrammes associes aux couples d'alpha-coupes.
   - F02 (hybrid forces) fluctuates between F0 and F2 following the value of parameter p0.
   - Histograms can be calculated for user defined value of r.

2/ The program has been cleaned up (reorganization, deprecation of functions/arguments/
   unused variables, modification of names, some new optimizations , etc. ).

3/ The dynamically allocated memory is now released after use.
   Some of the calls for "free" had been poorly placed in ver 2.0 of Feb 2001.
   They were placed outside of certain loops, and not within these loops.
   The version 2.01 of march 2001 repaired this error.
...
/*==============================================================
 Obtain pointer to each line in the image.
==============================================================*/
