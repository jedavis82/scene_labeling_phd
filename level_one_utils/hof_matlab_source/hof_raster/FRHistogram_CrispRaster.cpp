//-------------------------------------------------------------------------
// FRHistogram_CrispRaster.cpp
// 2/11/2011
// Author: Andrew Buck
//
// MATLAB MEX-file wrapper for the F-r histogram in the crisp raster case.
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    raster_obj.FRHistogram_CrispRaster(histogram, numberDirections, typeForce, imageA, imageB, M, N);
}