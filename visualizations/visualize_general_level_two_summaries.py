"""
Visualize the general domain level two summaries stored in the output CSV file
"""
...
OUTPUT_DIR = '../input/image_results/general_level_two/'
...
def main():
    l2_df = pd.read_csv(GENERAL_LEVEL_TWO_SUMMARIES_FILE, encoding='utf-8', engine='python')
    ...
    for p in img_paths:
        ...
        for idx, row in img_df.iterrows():
            ...
            l2_summary = row['general_level_two_summary']
            if 'Not Interacting' in l2_summary:
                continue
